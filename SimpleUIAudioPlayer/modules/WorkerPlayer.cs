...
namespace Dotnet
{
    partial class WorkerPlayer
    {
        ...
        public void PlayAllSongsInPlaylist(bool loopPlaylistFlag=false, bool loopSongFlag=false)
        {
            ...
            while (true)
            {
                ...
                else
                {
                    if(music.Finished)
                    {
                        Play(currentPlaylistAllSongs[currentPlaylistSongIndex], loopSongFlag);
                        CurrentSongInfo();
                        currentPlaylistSongIndex++;
                    }
                }
